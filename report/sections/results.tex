...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{sections/assets/Vertical_P_controller.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{sections/assets/Horizontal_P_controller.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{sections/assets/Vertical_PI_controller.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{sections/assets/Horizontal_PI_controller.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{sections/assets/Vertical_PD_controller.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{sections/assets/Horizontal_PD_controller.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{sections/assets/Vertical_PID_controller.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{sections/assets/Horizontal_PID_controller.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{sections/assets/Vertical_built_in_functions.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{sections/assets/Horizontal_built_in_funtion.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{sections/assets/Vertical_undamped_oscillation.png}
\caption{Close to undamped oscillations from \(40^{\circ}\) step with P-controller.}
\label{vert_osc}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{sections/assets/Horizontal_undamped_oscillation.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{sections/assets/Step Response.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{sections/assets/Kp40.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{sections/assets/Kp40_10Kd.jpg}
    \caption{The error can be seen on the y-axis while the x axis represents the iteration of the loop.}
    \label{Kp40_10Kd}
\end{figure}
