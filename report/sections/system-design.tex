...
Here it comes some of the results for the spacial position control simulation. In this case the desired position is (100, 100), the proportional gain for the angular velocity controller is $K_p = 4$ and the proportional gain for the average velocity controller is $K_p = 5$. If you are interested to see more plots, you can go to the Git-repository under simulation/Diff\_Drive/read\_me and you will find out how to generate more relative plots for this system.\\
